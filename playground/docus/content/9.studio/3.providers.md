...
:::warning
**Note**: Google OAuth is used for authentication only. You still need a GitHub Personal Access Token (`STUDIO_GITHUB_TOKEN`) to push changes to your repository. Do not forget next step.
:::
...
:::tabs
  ...
  Coming soon: GitLab Personal Access Token
  ::::
:::
...
Add the Google OAuth credentials and the GitHub Personal Access Token to your deployment platform's environment variables or in your `.env` file in local
