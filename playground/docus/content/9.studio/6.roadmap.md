...
The alpha release focuses on core functionality and stability. The alpha now includes the TipTap visual editor (default), the Monaco code editor, and the new form-based editor for YAML/JSON files and frontmatter, providing a complete editing experience for all content types with MDC component support.
